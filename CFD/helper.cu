...
void write_matrix( const char* szFileName,       /* filename */
		   ...
		   int ncl,		       /* first row */
		   int nch,		       /* last row */
		 float xlength,	       /* size of the geometry in */
                                               /* x-direction */
		 float ylength,	       /* size of the geometry in */
                                               /* y-direction  */
...
float **matrix( int nrl, int nrh, int ncl, int nch )
{
   ...
   float **pArray  = (float **) malloc((size_t)( nrow * sizeof(float*)) );
   float  *pMatrix = (float *)  malloc((size_t)( nrow * ncol * sizeof( float )));
